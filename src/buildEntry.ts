 ...
 *
 */
import { EngageServiceDesk } from './serviceDesks/engage/engageServiceDesk';
...
function getInstance(parameters: ServiceDeskFactoryParameters): EngageServiceDesk {
  return new EngageServiceDesk(parameters);
}
